...
<head>
    ...
    <script type="text/javascript" src="/dhd_system/dhd_system/Public/home/js/jquery.validate.js"></script>
...
<div id="content">
    ...
    <dl id="dl">
        <form method="post" action="/dhd_system/dhd_system/?s=Home/channel/channelsave_do" id="add">
            <dd>
            ...
            <dd>
                ...
                <span class="dd_right"><input type="text" name="middle_name" class="qtext" value="<?php echo ($data["middle_name"]); ?>" style="width:360px;"/></span>
            </dd>
            <dd>
                <span class="dd_left">联系人</span>
                <span class="dd_right"><input type="text" name="middle_man" class="qtext" value="<?php echo ($data["middle_man"]); ?>" style="width:360px;"/></span>
            </dd>
            <dd>
                <span class="dd_left">联系方式</span>
                <span class="dd_right"><input type="text" name="middle_tel" class="qtext" value="<?php echo ($data["middle_tel"]); ?>" style="width:360px;"/></span>
            </dd>
            <dd>
                <span class="dd_left">办公地址</span>
                <span class="dd_right"><input type="text" name="middle_address" class="qtext" value="<?php echo ($data["middle_address"]); ?>" style="width:360px;"/></span>
            </dd>
...
<script type="text/javascript">
    ...
    //             $.ajax({
    //                 url:'/dhd_system/dhd_system/?s=Home/User/useradd_do/',
    //                 dataType:'json',
    //                 type:'POST',
    ...
    //                     // alert(data)
    //                     if (data=='ok') {
    //                         wintq('添加成功',1,1500,0,'/dhd_system/dhd_system/?s=Home/channel/channel_index');
    //                     }else {
